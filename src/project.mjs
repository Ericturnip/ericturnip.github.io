...
const stories = {
  'hi-shells': {
    ...
    resources: material('/downloads/hi-shell-detection-2026.pdf', 'Read the paper · PDF') + material('https://github.com/Ericturnip/HIShell', 'Paper code · HIShell') + material('https://github.com/Ericturnip/HIShells', 'H I detection code · HIShells'),
